...
class TrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post trains_url, params: { train: { endtime: @train.endtime, name: @train.name, number: @train.number, rundays: @train.rundays, starttime: @train.starttime, totalcapacity: @train.totalcapacity, type: @train.type } }
    end
  ...
  test "should update train" do
    patch train_url(@train), params: { train: { endtime: @train.endtime, name: @train.name, number: @train.number, rundays: @train.rundays, starttime: @train.starttime, totalcapacity: @train.totalcapacity, type: @train.type } }
